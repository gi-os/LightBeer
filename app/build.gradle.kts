...
dependencies {
    ...
    // Video-scrubbed pour: frame-accurate seekTo() and crop-to-fill rendering via PlayerView.
    // Pinned at 1.4.x on purpose — 1.10.x's AAR metadata demands compileSdk 36, which is
    // past what AGP 8.7.3 (and this project's compileSdk 35) supports.
